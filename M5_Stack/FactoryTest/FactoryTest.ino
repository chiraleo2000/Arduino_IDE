...
void encoder() {
  ...
  M5.Lcd.setCursor(30, 120, 4);
  M5.Lcd.printf("code = %05d,button = %d\r ", count_change, value);
  delay(1);
...
void luminosity() {
  ...
  M5.Lcd.setCursor(30, 120, 4);
  M5.Lcd.printf("Analog:%1d", a_data);
  M5.Lcd.setCursor(160, 120, 4);
  M5.Lcd.printf("Digtal:%1d\n", d_data);
  delay(50);
...
void microphone() {
  ...
  a_data = analogRead(Analog);
  d_data = digitalRead(Digtal);
  Serial.printf("Analog:%1d  Digtal:%0d\n", a_data, d_data);
  M5.Lcd.setCursor(30, 120, 4);
  M5.Lcd.printf("Analog:%0d", a_data);
  M5.Lcd.setCursor(160, 120, 4);
  M5.Lcd.printf("Digtal:%1d\n", d_data);
  delay(50);
